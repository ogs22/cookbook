Sometimes, a difficult integral can be integrated by parts several times, yielding either successively simpler inetgrals or one that can be related to the original. The process iterates towards a solution.
For example:
\begin{eqnarray*}
...
\mathrm{I} &=& \frac{\mathrm{e}^{\mathrm{x}}}{2}(\mathrm{\sin x + \cos x})
\end{eqnarray*}
