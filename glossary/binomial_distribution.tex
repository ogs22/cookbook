A discrete distribution, written B(n, p) and given by:
\[ 
...
\par
As n becomes very large, the distribution becomes narrower, forming a peak
around X=pn (i.e. on average, a proportion p of the trials will be
successful).