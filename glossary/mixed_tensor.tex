...
a mixed tensor of order 2 is a set of components denoted $ \mathrm{A}^{\mathrm{i}}
_{\mathrm{j}} $
(with respect to $ \mathrm{x}^{\mathrm{i}} ) $ or $ \bar{\mathrm{A}}^{\mathrm{i}}
_{\mathrm{j}} $
(with respect to $ \bar{\mathrm{x}}^{\mathrm{i}} )  , $
and satisfying:
\[ \bar{\mathrm{A}}^{\mathrm{i}} _{\mathrm{j}}
...
\mathrm{A}^{\mathrm{r}} _{\mathrm{s}} , \]
for every i and j.
\par
Higher-order mixed tensors can be defined similarly. Note that unlike covariant
or contravariant tensors, a mixed tensor has both superscripts and subscripts.