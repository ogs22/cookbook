A way of performing approximate numerical integrations; it is equivalent to
assuming that the function being integrated is the same as a straight line
with the same end points as the function:
